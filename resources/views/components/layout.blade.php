...
<html lang="en">
  ...
  <body>
    ...
    @if (session()->has('error-not-logged-in'))
    <div class="container container--narrow">
    ...
    @auth
    <div data-username="{{auth()->user()->username}}" data-avatar="{{auth()->user()->avatar}}" id="chat-wrapper" class="chat-wrapper shadow border-top border-left">
    </div>
    @endauth
